...
class GenerateCodeState(State):
    def __init__(self, agent):
        super().__init__('generate', self.action)
        self.agent = agent
    ...
    def action(self, ctx):
        ...
        # Include last assistant response (optional)
        last_response = ""
